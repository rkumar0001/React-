...
const warehouseRoutes = require("./routes/dms/warehouseRoutes");
const inventoryRoutes = require("./routes/dms/inventoryRoutes");
...
// DAR
const activityTypeRoutes = require("./routes/activityTypeRoute");
const activityRelatedToRoutes = require("./routes/activityRelatedToRoute");
const nextActionOnRoutes = require("./routes/nextActionOnRoute");
const darStatusRoutes = require("./routes/statusRoute");
...
//   origin: ['*'] }));
// const corsOptions = {
//   origin: 'http://crm.saleofast.com:8050', // Your frontend origin
...
app.use("/api/v1/db/target", targetRoutes);
app.use("/api/v1/db/dar", darRoutes);
...
app.use("/api/v1/db/warehouse", warehouseRoutes);
app.use("/api/v1/db/inventory", inventoryRoutes);
...
// DAR
app.use("/api/v1/db/activityType", activityTypeRoutes);
app.use("/api/v1/db/activityRelatedTo", activityRelatedToRoutes);
app.use("/api/v1/db/nextActionOn", nextActionOnRoutes);
app.use("/api/v1/db/darStatus", darStatusRoutes);
